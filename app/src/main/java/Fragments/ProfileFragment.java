...
public class ProfileFragment extends Fragment {
    ...
    private StorageReference storageRef = FirebaseStorage.getInstance("gs://testingmad-489b9.appspot.com").getReference();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        postingButton = (Button) view.findViewById(R.id.postingButton);
        ordersButton = (Button) view.findViewById(R.id.ordersButton);
        setPostingsButtonListener();
        setMyOrdersButtonListener();
    ...
    private void setPostingsButtonListener() {
        currentUserRef = myRootRef.child("Users").child(user.getUid());
        processingRef = myRootRef.child("Processing");
    ...
    private void setMyOrdersButtonListener() {
        currentUserRef = myRootRef.child("Users").child(user.getUid());
        processingRef = myRootRef.child("Processing");
        postingsRef = currentUserRef.child("Postings");
        userBoughtRef = currentUserRef.child("Bought");
        final Fragment selectedFragment = OrderHistoryFragment.newInstance();
