...
import Fragments.ItemDetailsPostingsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showItemDescription2(View view) {
        String id = (String) view.getTag();
        ItemDetailsPostingsFragment.setItemIDToDisplay(id);
        Fragment selectedFragment = ItemDetailsPostingsFragment.newInstance();
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.frame_layout, selectedFragment);
        transaction.commit();
    }
